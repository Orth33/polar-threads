export default function ReturnsExchange() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="font-tafabricans text-center text-3xl font-extrabold text-gray-900 mb-4">
        Returns & Exchanges
      </h1>
      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-gray-600">
            ...
            unwashed, and have all original tags attached. Returns are free for
            store credit, or a $7.99 return shipping fee will be deducted for
        ...
        <section>
          ...
          <ol className="list-decimal list-inside text-gray-600 space-y-2">
            <li>
              Initiate your exchange through your account or contact customer
              service
            </li>
